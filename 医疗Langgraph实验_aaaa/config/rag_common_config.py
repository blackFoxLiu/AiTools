...
class Config:
    persist_directory = "D:/PythonProjects/AiTools/医疗Langgraph实验_aaaa/data/databases/rag_db/chroma_db"
    collection_name = "knowledge_base"
    md5_path = "D:/PythonProjects/AiTools/医疗Langgraph实验_aaaa/data/output/chroma_db_uploaded_md5.txt"
    chunk_size = 800
    chunk_overlap = 50
    separators = ["\n\n"] # , "。", "！", "？", "；", " ", "", "\n"
